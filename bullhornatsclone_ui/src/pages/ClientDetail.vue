						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  ...
								  <base-input label="ContactEmail" type="text" placeholder="Enter ContactEmail" v-model="clientToAdd.contactEmail"></base-input>
												                  </form>
								                </div>
            ...
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Contact Email</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="ContactEmail" type="text" placeholder="Enter ContactEmail" v-model="clientDetails.contactEmail"></input>
																		</div>
						</td>
														</tr>
