					...
					<tr> 
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  <div class="container">
												    <base-button class="btn btn-primary" @click="modal2Jobs = true">Add</base-button>
								              <modal :show.sync="modal2Jobs">
								  ...
								  <base-input label="Description" type="text" placeholder="Enter Description" v-model="jobToAdd.description"></base-input>
								  <base-input label="Location" type="text" placeholder="Enter Location" v-model="jobToAdd.location"></base-input>
								  <base-input label="Salary" type="text" placeholder="Enter Salary" v-model="jobToAdd.salary"></base-input>
												                  </form>
								                </div>
          ...
          <a-modal :footer="null" :visible="userPermissionDialog" :closable="false" class="centered-modal" v-if="userPermissionDialog">
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
										...
										<tr> 
					<td class="detail_view_column_2">Job Id</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="JobId" type="text" placeholder="Enter JobId" v-model="jobDetails.jobId"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Title</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Title" type="text" placeholder="Enter Title" v-model="jobDetails.title"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Description</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Description" type="text" placeholder="Enter Description" v-model="jobDetails.description"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Location</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Location" type="text" placeholder="Enter Location" v-model="jobDetails.location"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Salary</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Salary" type="text" placeholder="Enter Salary" v-model="jobDetails.salary"></input>
																		</div>
						</td>
														</tr>
