					...
					<tr> 
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  <div class="container">
												    <base-button class="btn btn-primary" @click="modal2Candidates = true">Add</base-button>
								              <modal :show.sync="modal2Candidates">
								  ...
								  <base-input label="Phone" type="text" placeholder="Enter Phone" v-model="candidateToAdd.phone"></base-input>
								  <base-input label="Skills" type="text" placeholder="Enter Skills" v-model="candidateToAdd.skills"></base-input>
								  <base-input label="Resume" type="text" placeholder="Enter Resume" v-model="candidateToAdd.resume"></base-input>
												                  </form>
								                </div>
          ...
          <a-modal :footer="null" :visible="userPermissionDialog" :closable="false" class="centered-modal" v-if="userPermissionDialog">
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
										...
										<tr> 
					<td class="detail_view_column_2">Candidate Id</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="CandidateId" type="text" placeholder="Enter CandidateId" v-model="candidateDetails.candidateId"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Name</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Name" type="text" placeholder="Enter Name" v-model="candidateDetails.name"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Email</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Email" type="text" placeholder="Enter Email" v-model="candidateDetails.email"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Phone</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Phone" type="text" placeholder="Enter Phone" v-model="candidateDetails.phone"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Skills</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Skills" type="text" placeholder="Enter Skills" v-model="candidateDetails.skills"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Resume</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Resume" type="text" placeholder="Enter Resume" v-model="candidateDetails.resume"></input>
																		</div>
						</td>
														</tr>
...
export default {
  ...
  methods: {
    ...
    async handleAddSubmitted() {
      this.modal2Candidates = false;

      const jsonData = JSON.stringify(this.candidateToAdd);
      console.log(jsonData);
      
      const res = await CandidateService.addCandidate(jsonData);
